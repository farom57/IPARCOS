...
public class INDISexagesimalFormatter {
	...
	private void checkFormat() throws IllegalArgumentException {
		...
		if ((fractionLength != 3) && (fractionLength != 5) && (fractionLength != 6) && (fractionLength != 8)
				&& (fractionLength != 9)) {
	...
	public String format(Double number) {
		...
		integerPart = (int) Math.floor(Math.abs(number));
		...
		String res = sign + integerPart + fractionalPart;
